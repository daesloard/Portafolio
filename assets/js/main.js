...
const COMMANDS = {
  ...
  no: "OK",
  about:
    "Hey There! My name is David Esteban Lopez, i am a web developer on my way to becoming a senior developer. in the meantime, i like to read book and drink a beer with my friends in my spare time, Feel free to visit my <a href ='https://github.com/daesloard' target='_blank' style='color:#000;'> Github",
  ls:
    "usr&nbsp;&nbsp;&nbsp;&nbsp;home&nbsp;&nbsp;&nbsp;&nbsp;var&nbsp;&nbsp;&nbsp;&nbsp;root",
  ...
  contact:
    "Email (daesloard@gmail.com): <a class='link' href='https://mail.google.com/'>Gmail</a><br>Form: <a href='/contact' class='link'> Anon Message</a><br>",
};
